...
var DatePicker = new Class({
	...
	create: function(dp){
		...
		if(!dp.options.dateonly) timeTextBox = new Element('input', {'id':dp.id + '_timeTextBox', 'class':'cal_timeTextBox', 'value':time});
		else                     timeTextBox = new Element('input', {'id':dp.id + '_timeTextBox', 'class':'cal_timeTextBox', 'value':time, 'type':'hidden'});
